fin-cli/admin-command
====================

Open /fin-admin/ in a browser.

[![Testing](https://github.com/fin-cli/admin-command/actions/workflows/testing.yml/badge.svg)](https://github.com/fin-cli/admin-command/actions/workflows/testing.yml)
...
```bash
fin package install fin-cli/admin-command:@stable
```

To install the latest development version of this package, use the following command instead:

```bash
fin package install fin-cli/admin-command:dev-main
```
...
Before you create a new issue, you should [search existing issues](https://github.com/fin-cli/admin-command/issues?q=label%3Abug%20) to see if there’s an existing resolution to it, or if it’s already been fixed in a newer version.

Once you’ve done a bit of searching and discovered there isn’t an open or fixed issue for your bug, please [create a new issue](https://github.com/fin-cli/admin-command/issues/new). Include as much detail as you can, and clear steps to reproduce if possible. For more guidance, [review our bug report documentation](https://make.finpress.org/cli/handbook/bug-reports/).

### Creating a pull request

Want to contribute a new feature? Please first [open a new issue](https://github.com/fin-cli/admin-command/issues/new) to discuss whether the feature is a good fit for the project.
